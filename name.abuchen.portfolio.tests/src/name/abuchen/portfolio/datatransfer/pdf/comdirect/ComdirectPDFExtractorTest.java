...
public class ComdirectPDFExtractorTest
{
    ...
    @Test
    public void testIssueComdirect2()
    {
        var extractor = new ComdirectPDFExtractor(new name.abuchen.portfolio.model.Client());
        List<Exception> errors = new ArrayList<>();
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "issue_comdirect_2.txt"), errors);
        ...
        assertThat(results, hasItem(purchase( //
                        hasDate("2026-05-04T10:53"), hasShares(400.0), //
                        hasSource("issue_comdirect_2.txt"), //
                        hasNote("Ord.-Nr.: 000519542794-001 | R.-Nr.: 704976837097DA05"), //
                        hasAmount("EUR", 1020.00), hasGrossValue("EUR", 1020.00), //
                        hasTaxes("EUR", 0.0), hasFees("EUR", 0.0))));
    }

    @Test
    public void testIssueComdirect3()
    {
        var extractor = new ComdirectPDFExtractor(new name.abuchen.portfolio.model.Client());
        List<Exception> errors = new ArrayList<>();
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "issue_comdirect_3.txt"), errors);
        ...
        assertThat(results, hasItem(purchase( //
                        hasDate("2026-05-04"), hasShares(0.605), //
                        hasSource("issue_comdirect_3.txt"), //
                        hasNote("R.-Nr.: 705004401165DD95"), //
                        hasAmount("EUR", 50.00), hasGrossValue("EUR", 49.26), //
                        hasTaxes("EUR", 0.0), hasFees("EUR", 0.74))));
    }

    @Test
    public void testIssueComdirect4()
    {
        var extractor = new ComdirectPDFExtractor(new name.abuchen.portfolio.model.Client());
        List<Exception> errors = new ArrayList<>();
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "issue_comdirect_4.txt"), errors);
